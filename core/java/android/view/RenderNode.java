 ...
 * {@link GLES20Canvas}. Replaying the operations from a display list avoids
 ...
 * <p>Display lists can only be replayed using a {@link GLES20Canvas}. They are not
 ...
 *         GLES20Canvas canvas = displayList.start(width, height);
 *         try {
 ...
 *             GLES20Canvas GLES20Canvas = (GLES20Canvas) canvas;
 *             GLES20Canvas.drawDisplayList(mDisplayList);
 *         }
 *     }
 * </pre>
 *
 ...
 *         GLES20Canvas canvas = mDisplayList.start(width, height);
 *         try {
...
public class RenderNode {
     ...
     * {@link GLES20Canvas#drawRenderNode
     ...
     *
     * @see GLES20Canvas#drawRenderNode(RenderNode, int)
     */
     ...
     *
     * @see GLES20Canvas#drawRenderNode(RenderNode, int)
     * @see GLES20Canvas#callDrawGLFunction2(long)
     */
     ...
     * {@link #end(GLES20Canvas)} is called.
     ...
     *
     * @see #end(GLES20Canvas)
     * @see #isValid()
     */
    public GLES20Canvas start(int width, int height) {
        GLES20Canvas canvas = GLES20RecordingCanvas.obtain(this);
     ...
     * @see #isValid()
     */
    public void end(GLES20Canvas endCanvas) {
